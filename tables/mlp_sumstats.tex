...
\end{adjustbox}
\footnotesize{\emph{Note:} Observations include all individuals linked by \href{https://usa.ipums.org/usa/mlp/mlp.shtml}{MLP} whose reported race is either Chinese or Japanese in 1940 and who have non-missing income data in both the 1940 and 1950 census.}
\end{table}