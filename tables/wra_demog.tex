\begin{table}
  \caption{\label{tbl:wra_demog} Demographics of Japanese Americans in 1940 Census and WRA records}
...
1940 Census column contains all respondents who are reported as Japanese.
Internee observations come from the WRA form 26 data.
}
\end{table}
