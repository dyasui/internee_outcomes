...
tbl_dt <- bind_rows(cen_demo, int_demo) |>
  mutate(
  cohort = case_when(
    BIRTHYR %in% 1940:1942 ~ "c4042",
    BIRTHYR %in% 1929:1939 ~ "c2939",
    BIRTHYR %in% 1924:1928 ~ "c2428",
    BIRTHYR %in% 1915:1923 ~ "c1523",
    BIRTHYR %in% 1905:1914 ~ "c0514",
    BIRTHYR %in% 1895:1904 ~ "c9504",
    BIRTHYR %in% 1885:1894 ~ "c8594",
    BIRTHYR %in% 1875:1884 ~ "c7584",
    BIRTHYR < 1875 ~ "pre75" )
  ) |> 
  filter(BIRTHYR %in% 1860:1940)
#+end_src
