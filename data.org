...
list(
  ...
  tar_target(internpr_county, calc_int_proportion(wra_data, ddi = ddi_path, by = c("STATEFIP", "COUNTYICP"))),
...
:PROPERTIES:
:HEADER-ARGS:R: :session *R:internment* :colnames yes :tangle R/linking.R
:END:
Reading all linked data from IPUMS MLP version 2
#+begin_src R :results output
mlp_ddi <- "data/mlp_v2_0/usa_00131.xml"
yield <- read_ipums_micro_yield(mlp_ddi)
yield$yield(0) |> colnames() 
#+end_src
...
Use of data from IPUMS USA is subject to conditions including that users should cite the data appropriately. Use command `ipums_conditions()` for more details.
 [1] "YEAR"          "SERIAL"        "STATEFIP"      "COUNTYICP"     "CITY"         
 [6] "URBAN"         "GQ"            "FARM"          "ACRENONF"      "PERNUM"       
[11] "SLREC"         "MOMLOC"        "POPLOC"        "SEX"           "AGE"          
[16] "MARST"         "BIRTHYR"       "RACE"          "RACED"         "BPL"          
[21] "BPLD"          "MBPL"          "MBPLD"         "FBPL"          "FBPLD"        
[26] "NATIVITY"      "CITIZEN"       "HIGRADE"       "HIGRADED"      "EDUC"         
[31] "EDUCD"         "EMPSTAT"       "EMPSTATD"      "LABFORCE"      "CLASSWKR"     
[36] "CLASSWKRD"     "OCC"           "OCC1950"       "IND"           "IND1950"      
[41] "WKSWORK1"      "HRSWORK1"      "DURUNEMP"      "INCTOT"        "INCWAGE"      
[46] "INCBUSFM"      "INCNONWG"      "INCOTHER"      "OCCSCORE"      "MIGRATE5"     
[51] "MIGRATE5D"     "MIGPLAC5"      "MIGCOUNTYICP5" "VERSIONHIST"   "VETSTAT"      
[56] "VETSTATD"      "VETWWII"       "HISTID"        "HIK"           "LINK1940"     
[61] "LINK1950"      "VERSIONHIK"    "NATIVITY_MOM"  "NATIVITY_POP"  "NATIVITY_SP"  
[66] "NATIVITY_MOM2" "NATIVITY_POP2" "HIGRADED_MOM"  "HIGRADED_POP"  "HIGRADED_MOM2"
[71] "HIGRADED_POP2" "EDUC_MOM"      "EDUC_POP"      "EDUC_MOM2"     "EDUC_POP2"    
[76] "EMPSTAT_MOM"   "EMPSTAT_POP"   "EMPSTAT_MOM2"  "EMPSTAT_POP2"  "OCC1950_MOM"  
[81] "OCC1950_POP"   "OCC1950_MOM2"  "OCC1950_POP2"  "INCWAGE_MOM"   "INCWAGE_POP"  
[86] "INCWAGE_MOM2"  "INCWAGE_POP2"  "OCCSCORE_MOM"  "OCCSCORE_POP"  "OCCSCORE_MOM2"
[91] "OCCSCORE_POP2" "VETWWII_MOM"   "VETWWII_POP"   "VETWWII_SP"    "VETWWII_MOM2" 
[96] "VETWWII_POP2"
#+end_example
...
Based on this, there are 19,278 individuals who are either Japanese or Chinese and linked between the 1940 and 1950 censuses for the current version of MLP.


The match rate for this population is less than the ~40% match rate in the MLP linkages overall.
Based on the numbers in the table above, the match rate for Japanese/Chinese respondents is 20341 / 204906 ≈ 10%.

To help save myself (and others) from having to read through the entire set of linking crosswalks in the future,
I will save a list of these histid crosswalks to a csv file in my repository.
#+begin_src R
write_csv(cw_list, file = "data/mlp_1940_1950_v1_2_csv/mlp_1940_1950_v1.2-JConly.csv")
#+end_src
...
* Cleaning and Defining Main Sample for Analysis
:PROPERTIES:
:HEADER-ARGS:R: :session *R:internment*
:END:
