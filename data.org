...
#+begin_src R 
  wide_df_lbld <- long_df |>
    pivot_wider(
      id_cols = any_of(c("id", "sex", "race", "birthyr_avg",
                         "income_bsfm", "income_tot", "income_oth")),
      names_from = YEAR,
      values_from = any_of(c("age", "salary",
        "STATEFIP", "COUNTYICP", "CITY", "URBAN", "GQ", "FARM",
        "ENUMDIST", "PERNUM", "SLWT", "SEX", "AGE", "MARST",
        "BIRTHYR", "CHBORN", "RACE", "RACED", "BPL", "BPLD", "MBPL",
        "MBPLD", "FBPL", "FBPLD", "NATIVITY", "CITIZEN", "SCHOOL",
        "HIGRADE", "HIGRADED", "EDUC", "EDUCD", "EMPSTAT", "EMPSTATD",
        "LABFORCE", "CLASSWKR", "CLASSWKRD", "OCC", "OCC1950", "IND",
        "IND1950", "WKSWORK1", "HRSWORK1", "DURUNEMP", "INCTOT",
        "INCWAGE", "INCBUSFM", "INCOTHER", "OCCSCORE", "MIGRATE5",
        "MIGRATE5D", "MIGPLAC5", "MIGCOUNTYICP5"))
      )
#+end_src
