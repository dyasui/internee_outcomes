...
or that some children who show up in the internment camps 
were yet to be born in 1940.
Voluntary migration could also affect these interned proportions.
...
who lived in county $c$ in 1942, $Pr(c(i)_{1942}, z_i)$,
...
and not in 1942, $c(i)_{1940}$ is used as a proxy 
...
then the ratio of residents in 1940 vs 1942 would be greater than 1 
...
my main analysis follows the following specification:
...
include age, sex, and individual $i$'s earnings from the 1940 census,
adjusted to 1950 dollars.
In some specifications,
I also apply a fixed effect for the state 
in which individual $i$ is living in 1950
