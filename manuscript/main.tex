...
the coefficients in tablt \ref{tbl:reg2} are not significantly different than zero.
...
Figure \ref{fig:wageeffect} shows the scatterplot of the percentage change in
dollar earnings from 1940 to 1950 among the main analysis sample against the
predicted internment status measure from equation \ref{eq:predint}.
While there does not seem to be any differential changes between Japanese women
who are more likely to be interned, 
Japanese men who are more likely to be interned on
average experienced higher wage growth than those who were not interned.
...
\input{../tables/cmp-cty_tbl}\label{tbl:cmp-cty}
